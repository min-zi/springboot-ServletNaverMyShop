package com.ming.snavermyshop.integration;
...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT) // 스프링이 뜰 때 포트번호가 필요하니까 충돌되지 않게 랜덤포트 사용
@TestInstance(TestInstance.Lifecycle.PER_CLASS)
@TestMethodOrder(MethodOrderer.OrderAnnotation.class) // 테스트 실행 순서 지정하기 위해 선언
